...
This leads me to the preliminary conclusion that the partial index (which notably uses a slightly different set of transcipts at this stage, due to not being built locally) may not be worth pursuing, as it seems to make very little difference.
