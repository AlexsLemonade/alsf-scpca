...
Both Alevin and Cell Ranger perform more complicated filtering as part of their default workflows that are based on somewhat more elaborate calculations, but the bulk of the included cells will still above below this threshold.
