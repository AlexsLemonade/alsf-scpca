...
Cellranger, Kallisto, and alevin-fry-unfiltered-sketch (with the pre mRNA index) actually seem to be have the highest UMIs/cell. 
...
Kallisto is on the higher end, but is consistently capturing more genes. 
