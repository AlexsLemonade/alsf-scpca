...
spaceranger_spe <- read10xVisium(file.path(spaceranger_dir, "outs"), sample_id = sample_id)
```
...
go_results
```
It looks like genes in pathways affecting blood vessel development and wound healing are identified as being differentially quantified across the two tools. 
...
- Genes showing differential gene expression across the two tools appear to be involved in blood vessel development and wound healing.  
